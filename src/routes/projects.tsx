                  ...
                  {project.technologies.map((tech) => {
                    return (
                      <span
                        ...
                        className="inline-block bg-neutral group-hover:bg-primary group-hover:text-primary-content rounded-full px-[.4rem] py-[.3rem] text-xs text-neutral-content transition-colors duration-200"
                      >
                        {tech}
                      </span>
                    );
